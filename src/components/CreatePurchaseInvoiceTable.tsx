...
interface CreatePurchaseInvoiceTableProps {
  columns: Column[];
  data: any[];
  tableTitle?: string;
...
const CreatePurchaseInvoiceTable: React.FC<CreatePurchaseInvoiceTableProps> = ({
  eye,
  enableRowModal = true,
  onRowClick,
  className,
        ...
        >
          ...
          >
            ...
            <div className="mt-8 text-start pb-8 px-6 shadow-[0_2px_2px_0_#00000026]">
              ...
              <p className="text-sm text-gray-700">
                The item has been removed from the purchase invoice.
              </p>
            </div>
            <div className="flex justify-center gap-2 pb-3 py-4 px-6 shadow-[0_2px_2px_0_#00000026]">
              <Button
...
export default CreatePurchaseInvoiceTable;
