...
const PurchaseOrderTable: React.FC<PurchaseOrderTableProps> = ({
  ...
  const handleEditSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (updatePurchaseOrder && editingRow && formData) {
      ...
      const updateData = {
        supplierCompanyName:
          selectedSupplier?._id || formData.supplierCompanyName,
      ...
      updatePurchaseOrder(editingRow._id, updateData);
    }
  };
    ...
    <>
      ...
      >
        ...
        >
          <div className="flex gap-3">
            {searchable && (
              <Input
                placeholder="Search by Barcode, Category"
                value={search}
      ...
      {isEditing && formData && (
        <>
          ...
          >
            <div
              className="animate-scaleIn bg-white w-[90vw] overflow-hidden sm:w-lg md:w-[80vw] lg:w-3xl xl:w-4xl h-[70vh] overflow-y-auto rounded-[7px] shadow-lg"
              onClick={(e) => e.stopPropagation()}
            >
              ...
              >
                <div className="">
                  <div className="mt-6 mb-4 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 xl:gap-12 text-[15px] Poppins-font font-medium">
