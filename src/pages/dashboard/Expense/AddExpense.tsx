...
//   // Loading States
//   const [loadingExpenseCategoryDetails, setLoadingExpenseCategoryDetails] = useState(false)
...
//       const response = await axios.get(`${API_URL}/api/abid-jewelry-ms/getAllExpenseCategories`, {
//         headers: {
...
//     try {
//       const token = getAuthToken()
//       const response = await axios.get(`${API_URL}/api/abid-jewelry-ms/getAllCurrencies`, {
//         headers: {
//           "x-access-token": token,
//         },
//       })
...
//     try {
//       const token = getAuthToken()
//       const response = await axios.get(`${API_URL}/api/abid-jewelry-ms/getAllTaxes`, {
//         headers: {
//           "x-access-token": token,
//         },
//       })
...
//     try {
//       const token = getAuthToken()
//       const response = await axios.get(`${API_URL}/api/abid-jewelry-ms/getAllDurations`, {
//         headers: {
//           "x-access-token": token,
//         },
//       })
...
//     try {
//       const token = getAuthToken()
//       const response = await axios.get(`${API_URL}/api/abid-jewelry-ms/getAllPayments`, {
//         headers: {
//           "x-access-token": token,
//         },
//       })
...
//   const handleExpenseDescriptionChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
...
//       formData.append("date", expenseDate ? expenseDate.format("M-D-YYYY") : "")   ;  formData.append("currency", selectedCurrency);
...
//       const response = await axios.post(`${API_URL}/api/abid-jewelry-ms/createExpense`, formData, {
//         headers: {
//           "x-access-token": token,
...
//           <div className="p-4">
//             <p className="Source-Sans-Pro-font text-[#056BB7] font-semibold text-[20px] mb-2">Add New Expense</p>
//             <div className="flex flex-col text-[15px] Poppins-font font-medium mt-3">
//               <div className="flex items-center gap-1 mb-1">
//                 <label className="text-sm font-medium text-gray-800">Expense category</label>
...
//                 >
//                   <img src={plusIcon || "/placeholder.svg"} alt="Add" className="w-4 h-4" />
//                 </button>
//               </div>
//               <Dropdown
...
//                 className=""
//                 onSelect={(value) => {
//                   const selectedCategory = expenseCategories.find((cat) => cat.name === value)
//                   if (selectedCategory) {
//                     setSelectedExpenseCategory(selectedCategory._id) // Fix: Use correct state
//                   }
//                 }}
//               />
//               <div className="flex flex-col mb-3 mt-3">
//                 <label htmlFor="" className="mb-1">
//                   Attach Receipt <span className="text-[11px]">(Upload)</span>
//                 </label>
//                 <Dragger {...props} className="mb-1 w-full" height={170}>
//                   <p className="ant-upload-drag-icon ">
//                     <CloudUploadOutlined className="!text-[#000000e0]" />
//                   </p>
//                   <p className="ant-upload-text !mb-3 !font-medium">Upload or drag receipt image/file here</p>
//                   <p className="ant-upload-hint !bg-[#1A8CE0] !text-white rounded-md px-6 py-1 inline">Upload</p>
//                 </Dragger>
//               </div>
...
//             <p className="Source-Sans-Pro-font text-[#056BB7] font-semibold text-[20px] mb-2">Advanced Options</p>
//             <div className="flex flex-col text-[15px] Poppins-font font-medium mt-3">
//               <div className="flex items-center gap-1 mb-1">
...
//                 className=""
//                 onSelect={(value) => {
//                   const selectedCurrencyObj = currencies.find((curr) => curr.name === value)
//                   if (selectedCurrencyObj) {
//                     setSelectedCurrency(selectedCurrencyObj._id) // This is correct
//                   }
//                 }}
//               />
...
//                   <div className="flex flex-col mb-3">
//                     <label className="text-sm font-medium text-gray-800">Tax</label>
//                     <Dropdown
//                       options={taxes.map((tax) => `${tax.taxAmount}% `)}
//                       defaultValue="Select Tax"
//                       className="w-full"
//                       onSelect={(value) => {
//                         const selectedTaxObj = taxes.find((tax) => `${tax.taxAmount}% ` === value)
//                         if (selectedTaxObj) {
...
//                       className=""
//                       onSelect={(value) => {
//                         const selectedModeObj = paymentModes.find((mode) => mode.name === value)
//                         if (selectedModeObj) {
...
//                   <div className="flex flex-col mb-3">
//                     <label htmlFor="" className="mb-1">
//                       Repeat Every <span className="text-[11px]">(optional)</span>
//                     </label>
//                     <Dropdown
...
//                       className=""
//                       onSelect={(value) => {
//                         const selectedDurationObj = durations.find((duration) => duration.name === value)
...
//             </div>
//           </div>
//           <div className="flex justify-end font-medium pt-2 mt-6">
//             <Button text="Save" className="px-6 !bg-[#056BB7] text-white !border-none" onClick={handleCreateExpense} />
//           </div>
//         </div>
//       </div>
...
//                 </div>
//               ) : (
//                 <form onSubmit={handleSubmitCurrency} className="text-[15px] Poppins-font font-medium w-full p-4">
//                   <div className="flex flex-col mb-3">
...
const AddExpense: React.FC<AddExpenseProps> = ({ initialData, isEditing = false, expenseId }) => {
  const [selectedUser, setSelectedUser] = useState(null)
  const [showDeleteModal, setShowDeleteModal] = useState(false)
  const [image, setImage] = useState<UploadFile | null>(null)
  const [status, setStatus] = useState<"success" | "error" | null>(null)
  ...
  const handleCreateOrUpdateExpense = async () => {
    try {
      ...
      formData.append("expenseName", expenseName)
      formData.append("description", description)
      formData.append("date", expenseDate ? expenseDate.format("M-D-YYYY") : "")
          ...
          <div className="p-4">
            ...
            <div className="flex flex-col text-[15px] Poppins-font font-medium mt-3">
              ...
              <Dropdown
                options={expenseCategories.map((category) => category.name)}
                defaultValue={
                  isEditing && initialData?.expenseCategory?.name ? initialData.expenseCategory.name : "Select Category"
                }
                className=""
                onSelect={(value) => {
                  const selectedCategory = expenseCategories.find((cat) => cat.name === value)
        ...
        <div className="!h-fit">
          <div className="p-4 bg-white rounded-2xl shadow">
            ...
            <div className="flex flex-col text-[15px] Poppins-font font-medium mt-3">
              ...
              <Dropdown
                options={currencies.map((currency) => currency.name)}
                defaultValue={isEditing && initialData?.currency?.name ? initialData.currency.name : "Select Currency"}
                className=""
                onSelect={(value) => {
                  const selectedCurrencyObj = currencies.find((curr) => curr.name === value)
                  if (selectedCurrencyObj) {
                ...
                <div className="w-full xl:w-1/2 mt-4.5">
                  <div className="flex flex-col mb-3">
                    ...
                    <Dropdown
                      options={taxes.map((tax) => `${tax.taxAmount}% `)}
                      defaultValue={
                        isEditing && initialData?.tax?.taxAmount ? `${initialData.tax.taxAmount}%` : "Select Tax"
                      }
                      className="w-full"
                      onSelect={(value) => {
                        const selectedTaxObj = taxes.find((tax) => `${tax.taxAmount}% ` === value)
                ...
                <div className="w-full xl:w-1/2 mt-3">
                  <div className="flex flex-col mb-3">
                    ...
                    <Dropdown
                      options={durations.map((duration) => duration.name)}
                      defaultValue={
                        isEditing && initialData?.repeatEvery?.name ? initialData.repeatEvery.name : "Select Duration"
                      }
                      className=""
                      onSelect={(value) => {
                        const selectedDurationObj = durations.find((duration) => duration.name === value)
