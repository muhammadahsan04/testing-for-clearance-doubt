import { ApplePayTransferTable } from "../../../components/ApplePayTransferTable";
...
export default function ApplePay() {
  ...
  // Sample data for the table - moved from Apple PayTable to here
  ...
  return (
    <div className="w-full mx-auto px-4 py-6 sm:px-6 lg:px-8">
      ...
      {/* Apple Pay Table Component */}
      <ApplePayTransferTable transactions={transactions} />
    </div>
  );
}
