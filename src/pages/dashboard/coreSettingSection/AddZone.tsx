...
const AddZone: React.FC = () => {
  ...
  // FIXED: Remove representative and reset dropdown
  const removeRepresentative = (index: number) => {
    const newRepresentatives = formData.zoneRepresentative.filter(
      (_, i) => i !== index
    );
  ...
  // FIXED: Remove store and reset dropdown
  const removeStore = (index: number) => {
    const newStores = formData.stores.filter((_, i) => i !== index);
    const newStoreNames = selectedStoreNames.filter((_, i) => i !== index);
  ...
  const handleStoreSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Trigger StoreDropDown refresh to get updated data
        setStoreDropdownRefreshKey((prev) => prev + 1);
                ...
                <div className="space-y-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <Input
                      ...
                      className="outline-none focus:outline-none w-full"
                      value={storeFormData.facebookLink}
                      onChange={(e) =>
                        setStoreFormData((prev) => ({
                          ...prev,
                    ...
                    <Input
                      ...
                      className="outline-none focus:outline-none w-full"
                      value={storeFormData.instagramLink}
                      onChange={(e) =>
                        setStoreFormData((prev) => ({
                          ...prev,
                    ...
                    <Input
                      ...
                      className="outline-none focus:outline-none w-full"
                      value={storeFormData.linkedinLink}
                      onChange={(e) =>
                        setStoreFormData((prev) => ({
                          ...prev,
