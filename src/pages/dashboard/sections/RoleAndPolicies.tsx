...
//   // Add this function to handle select all with loading state
...
//       // Update all permissions for all modules
...
//       // Only fetch permissions if we don't already have them or if they're empty
//       if (
//         !existingPermissions ||
...
//     if (!canUpdate) {
//       toast.error("You don't have permission to edit role");
//       return;
//     }
...
//         setIsEditing(true);
//         setEditingRoleId(roleId); // Store the role being edited

//         // Clear any previously uploaded file
//         setUploadedFile(null);

//         // Set the role image URL for preview
//         setRoleImageUrl(`${API_URL}${role.roleImage}` || "");

//         // Set the form data with the fetched role details
...
//   // Update the useEffect that selects first role
//   useEffect(() => {
//     if (roles.length > 0 && !initialRolesLoadedRef.current) {
//       initialRolesLoadedRef.current = true;
...
//           })
//         );
//         // Don't fetch permissions here since it will be handled by the other useEffect
//       }
//     }
//   }, [roles, selectedRoleId, dispatch]);
...
//   //     }
//   //   }
//   // }, [selectedRoleId, dispatch, permissionsByRoleId]);

//   // Update the useEffect that fetches permissions when a role is selected
//   useEffect(() => {
//     if (selectedRoleId) {
//       // Check if we already have permissions data for this role
//       const existingPermissions = permissionsByRoleId[selectedRoleId];
...
//           .unwrap()
//           .then((result) => {
//             // Add toast messages here instead of in the slice
//             if (result.permissionExists) {
//               toast.success("Permissions loaded successfully");
//             } else {
//               toast.info(
//                 "No permissions found for this role. You can create new ones."
//               );
//             }
//           })
//           .catch((error) => {
...
//         </div>
//       </div>
//       {/* Use the UploadPicture component */}
//       {/* <UploadPicture
//         showModal={showModal}
...
//         selectedRoleId={isEditing ? selectedRoleId : ""}
...
//         }}
//       /> */}
//       {/* // Update the UploadPicture component props */}
//       <UploadPicture
//         showModal={showModal}
//         setShowModal={setShowModal}
//         isEditing={isEditing}
...
//                 onClick={() => {
//                   handleDeleteConfirm(deleteRole._id);
//                 }}
...
//   // Add this after handleSavePermissions function
...
//   //       // Set the role image URL for preview
//   //       setRoleImageUrl(`${API_URL}${role.roleImage}` || "");
//   //       // console.log("role.roleImage", `${API_URL}${role.roleImage}`);
...
//                   variant="border"
//                   fontFamily="Source-Sans-Pro-font border-2 mr-3 md:mr-6 md:lg:mr-8"
//                   text={permissionsData.permissionExists ? "Update" : "Save"}
//                   className="bg-black"
//                   onClick={handleSavePermissions}
